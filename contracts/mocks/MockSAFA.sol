...
/**
 * A mock version of sAFA, with an over-simplified rebase mechanism, for testing purposes only
 */
contract MockSAFA is ERC20 {
    ...
    constructor(uint256 initialIndex_, uint256 rebasePct_) ERC20('Mock sAFA', 'sAFA') {
