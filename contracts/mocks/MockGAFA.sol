...
// TODO fulfills IgAFA but is not inheriting because of dependency issues
contract MockGAFA is MockERC20 {
    /* ========== CONSTRUCTOR ========== */

    uint256 public immutable index;

    constructor(uint256 _initIndex) MockERC20('Governance AFA', 'gAFA', 18) {
        index = _initIndex;
    }
